...
For multilayer and heterogeneous networks, the formalism for fusing multiple relations over \emph{one}
...
On temporal dynamics, the second invariant requires a model of time. The memory-based TGN
...
In fraud and anomaly detection on graphs, the closest apparatus comes from fraud detection robust to
...
On adversarial robustness and self-supervised learning, since an attacker can \emph{fabricate} edges
...
In security applications of graphs, including phishing and threat intelligence, graph-based phishing detection has so far
